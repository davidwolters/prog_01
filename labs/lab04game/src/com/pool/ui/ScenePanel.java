...
import com.pool.scenes.GameOverScene;
...
public class ScenePanel extends JPanel implements ActionListener, MouseMotionListener, MouseListener {
	...
	public static void gameOver(boolean stripedWins) {
		instance.setScene(new GameOverScene(instance, stripedWins));
	}
	
	public static void startOver() {
		getInstance().setScene(new PoolScene(instance));
	}
