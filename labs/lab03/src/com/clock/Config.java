...
public class Config {
	...
	public static final int CLOCK_RADIUS = 200;
	...
	public static final class Hands {
		public static final int H_LENGTH = 100;
		public static final int M_LENGTH = 150;
		public static final int S_LENGTH = 180;
		public static final int H_WIDTH = 2;
		public static final int M_WIDTH = 2;
		public static final int S_WIDTH = 2;
		public static final int H_CIRCLE_SIZE = 20;
		public static final int M_CIRCLE_SIZE = 15;
		public static final int S_CIRCLE_SIZE = 10;
		public static final Color H_COLOR = new Color(100, 100, 100);
